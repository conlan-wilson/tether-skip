...
internal val logger: SkipLogger = SkipLogger(subsystem = "tether.module", category = "Tether")

private typealias AppRootView = TetherRootView
private typealias AppDelegate = TetherAppDelegate
